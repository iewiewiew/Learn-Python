...
module.exports = function(){
    ...
    it('url: https://www.zhihu.com', async function(){
        await driver.url(_(`https://www.zhihu.com`));
    });
    ...
    it('click: input[name="username"], 41, 31, 0', async function(){
        await driver.sleep(300).wait('input[name="username"]', 30000)
               .sleep(300).mouseMove(41, 31).click(0);
    });

    it('expect: val, //div[text()="请输入手机号"], equal, 200', async function(){
        await driver.sleep(300).wait('//div[text()="请输入手机号"]', 30000)
            .val()
